...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (!res || !res.tracks.length)
      return interaction
        .reply({ content: `No search results found. ❌`, ephemeral: true })
        .catch((e) => {});
    ...
    collector.on("collect", async (query) => {
      ...
      try {
        ...
        return interaction
          .reply({ content: `I can't join audio channel. ❌`, ephemeral: true })
          .catch((e) => {});
      }
    ...
    collector.on("end", (msg, reason) => {
      if (reason === "time")
        return interaction
          .reply({ content: `Song search time expired ❌`, ephemeral: true })
          .catch((e) => {});
    });
  },
};
